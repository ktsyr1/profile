...
export default function Contact({ data }) {
    return (
        <div className="box grid center-col">
            <div className="links ">
                <h1 >تواصل معنا</h1>
                <div style={{
                    height: '110px',
                    ...
                    <a href="https://wa.me/96170723177">
                    ...
                    <a href="mailto:ktsyr1@gmail.com">
                ...
                <div className="box row ">
                    ...
                    <a href="https://www.facebook.com/ktsyr1">
                        <img src='/icon/facebook.svg' alt='icon facebook' />
                    </a>
                    <a href="https://m.me/ktsyr1">
